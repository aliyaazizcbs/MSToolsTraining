...
function SignupFormSolution() {
  ...
  const isSignupEnabled = firstName !== '' && email !== '' && password !== '' && !passwordMismatch && confirmPassword !== ''

  const isClearEnabled = firstName !== '' || lastName !== '' || email !== '' || password !== '' || confirmPassword !== ''
...
export default SignupFormSolution
